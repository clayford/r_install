...
2. click the "Download R 3.6.2 for Windows" link.
...
If using Windows, you will likely have a personal library where packages are installed. It's usually under `Documents\R\win-library`. The name of this folder will be the first two version numbers. If you have version 3.4.1 installed, it will be named 3.4. When you install version 3.5.0, a 3.5 folder will be created. What you'll want to do is copy packages from the 3.4 folder to the 3.5 folder and then update your packages. Or delete the 3.5 folder, rename the 3.4 folder to 3.5, and then update your packages. For more information see the Windows FAQ: https://cran.r-project.org/bin/windows/base/rw-FAQ.html#What_0027s-the-best-way-to-upgrade_003f 
