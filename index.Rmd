...
2. click the "Download R 4.4.2 for Windows" link.
...
2. Click the appropriate "pkg" file for your computer: 
    * Select "R-4.4.2-arm64.pkg" if you’re running macOS 11 (Big Sur) or higher on a M1 or higher Mac.
    * Select "R-4.4.2-x86_64.pkg" if you’re using an older Intel Mac.
