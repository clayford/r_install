...
2. click the "Download R 4.2.2 for Windows" link.
...
2. click either "R-4.2.2-arm64.pkg" or "R-4.2.2.pkg" depending on your operating system.
    * Select "R-4.2.2-arm64.pkg" if you're using macOS 11 (Big Sur) or higher on a M1 or higher Mac.
    * Select "R-4.2.2.pkg" if you're using macOS 10.13 (High Sierra) or higher on an Intel Mac.
3. When the file finishes downloading, double-click to install. You should be able to just click "Next" to all dialogs to finish the installation.
